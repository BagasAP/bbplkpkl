...
class PesertaController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('peserta.index',compact('peserta','program','kejuruan','subkejuruan'));
    }
    ...
    public function create()
    {
        ...
        $program = TbMProgram::all();
        $peserta = tb_m_peserta::all();
        return view('program.create', compact('program','peserta'));
    }
    ...
    {
        //
        $this->validate($request,['no_daftar'=>"required|unique:tb_m_pesertas,no_daftar"]);
